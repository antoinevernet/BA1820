...
```{r, eval = TRUE, echo = TRUE, fig.align = "center", out.width = "50%", fig.retina = NULL}
...
- Behind two of those doors there is a goat, behind the third door there is a prize.
...
With your syndicate group, you will complete a short report on a dataset.
The report is due on Sunday the 8^th^ of October.
The report will cover the following:

- Description of a dataset (dimensions, content of each of the variables).
